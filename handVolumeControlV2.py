...
while True:
     ...
     if len(lmList) != 0:
          ...
          if 200 < area < 1500:
               ...
               if not fingers[4]:
                    lenght, img, lineInfo = detector.findDistance(p1=4, p2=8, img=img,draw=False)
     ...
     cv2.putText(img, f"%:{int(cVol)}", (10,70), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 2)
     #FPS COUNTER
     cv2.putText(img, f"FPS:{int(fps)}", (10,440), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 2)
     #DISPLAY
